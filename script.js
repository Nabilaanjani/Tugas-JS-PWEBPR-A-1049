document.getElementById("iya").addEventListener("click",function(){
    ...
    document.getElementById("gambar").src="./src/images/teknisi.png"
    document.getElementById("deskripsi").innerText="Anda adalah seorang Teknisi"
...
document.getElementById("tidak").addEventListener("click",function(){
    ...
    document.getElementById("gambar").src="./src/images/mahasiswa.png"
    document.getElementById("deskripsi").innerText="Anda adalah seorang Mahasiswa"
    document.getElementById("semua-tombol").style="visibility: hidden"
})